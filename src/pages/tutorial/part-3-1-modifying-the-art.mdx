...
title: 'Part 3-1: Modifying Game Art | melonJS Platformer Tutorial'
description: Edit game sprites and textures for your HTML5 platformer using Krita. Learn how to modify and replace game art assets in melonJS.
---
...
<a href="https://krita.org/en/">
    <Image class="krita" alt="Krita logo" src={kritaLogo} />
</a>
...
![Modified texture image inside Krita](../../assets/tutorial/texture-in-krita.png)

_I gave him some pants, a crown, and some spiky green hair :)_

![Custom skin running in my browser](../../assets/tutorial/new-skin-demo.png)
