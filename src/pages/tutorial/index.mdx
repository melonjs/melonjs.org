...
title: 'HTML5 Platformer Game Tutorial: Hacking a Platformer — melonJS'
description: Learn to build and modify an HTML5 platformer game with melonJS. A beginner-friendly tutorial covering game art, level design with Tiled, and JavaScript game code.
---
